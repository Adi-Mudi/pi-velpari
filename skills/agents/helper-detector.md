...
description: HELPER DETECTOR (prd stage) — read brainstorm notes and identify helper functions (HF-N) that the implementation will need. Writes a structured JSON report.
...
Read the brainstorm notes and identify helper functions the implementation
