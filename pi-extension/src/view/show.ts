 ...
 *   show-brainstorm  -> Doc/brainstorm/brainstorm-<topic-slug>.md
...
export async function showBrainstorm(
	...
	const resolved = resolveBrainstormArtifact(topicSlug, cwd);
	const grouped = join(cwd, buildGroupedBrainstormPath(topicSlug));
	void grouped;
