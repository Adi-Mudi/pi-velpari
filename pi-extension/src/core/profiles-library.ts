...
export const COMMON_PSRS_CORE_PROFILE: BuiltInProfile = {
	...
	reason:
		"Common PSRS core: Objective, Problem, Actors, User Stories, Scope, " +
		"MVP, Success Metrics, Phases, FR, NFR, Data and Interfaces, Errors " +
		"and Edge Cases, Constraints, Dependencies and Risks, Out of Scope, " +
		"Open Questions, Acceptance Criteria, Helper Function Candidates, " +
		"Glossary. Baseline for any project.",
};
...
function scoreCommonCore(answers: RequirementsAnswers): Scored {
	...
	const reasons: string[] = [
		...
		"Includes Objective, Problem, Actors, User Stories, Scope, MVP, Success Metrics, Phases, FR, NFR, Data and Interfaces, Errors and Edge Cases, Constraints, Dependencies and Risks, Out of Scope, Open Questions, Acceptance Criteria, Helper Function Candidates, Glossary.",
	];
