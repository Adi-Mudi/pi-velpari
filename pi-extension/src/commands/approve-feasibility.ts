...
/**
 * Manual recovery command for the feasibility stage (v1.6.0).
 *
 ...
 */
export function registerFeasibilityApproveCommand(pi: ExtensionAPI): void {
	pi.registerCommand("velpari-feasibility-approve", {
		description: "Manual fallback publish for the feasibility stage (v1.6.0).",
