...
/**
 * Manual recovery command for the development-order stage (v1.6.0).
 *
 ...
 */
export function registerDevelopmentOrderApproveCommand(pi: ExtensionAPI): void {
	pi.registerCommand("velpari-development-order-approve", {
		description: "Manual fallback publish for the development-order stage (v1.6.0).",
