...
/**
 * Manual recovery command for the rtm stage (v1.6.0).
 *
 ...
 */
export function registerRtmApproveCommand(pi: ExtensionAPI): void {
	pi.registerCommand("velpari-rtm-approve", {
		description: "Manual fallback publish for the rtm stage (v1.6.0).",
