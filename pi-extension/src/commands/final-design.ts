...
export function registerFinalDesignCommand(pi: ExtensionAPI): void {
	pi.registerCommand("velpari-final-design", {
		description: "Final-design consolidation (renamed from /velpari-html-design on 2026-09-14; today produces Doc/design/final-design_<project>.md, not actual HTML).",
