...
/**
 * Manual recovery command for the prd stage (v1.6.0).
 *
 ...
 */
export function registerPrdApproveCommand(pi: ExtensionAPI): void {
	pi.registerCommand("velpari-prd-approve", {
		description: "Manual fallback publish for the prd stage (v1.6.0).",
