...
/**
 * Manual recovery command for the architecture-generator stage (v1.6.0).
 *
 ...
 */
export function registerArchitectureGeneratorApproveCommand(pi: ExtensionAPI): void {
	pi.registerCommand("velpari-architecture-generator-approve", {
		description: "Manual fallback publish for the architecture-generator stage (v1.6.0).",
