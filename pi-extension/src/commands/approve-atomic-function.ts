...
/**
 * Manual recovery command for the atomic-function stage (v1.6.0).
 *
 ...
 */
export function registerAtomicFunctionApproveCommand(pi: ExtensionAPI): void {
	pi.registerCommand("velpari-atomic-function-approve", {
		description: "Manual fallback publish for the atomic-function stage (v1.6.0).",
