...
/** Walk up from this helper file until we find a package.json named
 *  "pi-velpari" (pre-scope) or "@adi-mudi/pi-velpari" (official npm scope,
 *  since the 1da48de rename). Returns the absolute path to that project
 *  root, or null. */
